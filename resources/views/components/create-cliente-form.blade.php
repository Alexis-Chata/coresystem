    ...
    <div x-show="open" @click.away="open = false"
        ...
        <form wire:submit.prevent="createCliente" class="p-4">
            <div class="mb-4">
                ...
                <input wire:model="newCliente.razon_social"
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                    id="razon_social" type="text" placeholder="Razón Social">
                @error('newCliente.razon_social')
            ...
            <div class="mb-4">
                ...
                <input wire:model="newCliente.direccion"
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
            ...
            <div class="mb-4">
                ...
                <select wire:model="newCliente.f_tipo_documento_id"
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                    id="f_tipo_documento_id">
                ...
                @error('newCliente.f_tipo_documento_id')
                    <span class="text-red-500 text-xs italic">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="mb-4">
                ...
                <input wire:model="newCliente.numero_documento"
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                    id="numero_documento" type="text" placeholder="Número de Documento">
                @error('newCliente.numero_documento')
                    <span class="text-red-500 text-xs italic">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="mb-4">
                ...
                <input wire:model="newCliente.celular"
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
            ...
            <div class="mb-4">
                <x-searchable-select :options="App\Models\Ruta::when(
                    ...
                    })" wire-model="newCliente.ruta_id" field="ruta_id" label="Ruta"
            ...
            <div class="mb-4">
                ...
                <select wire:model="newCliente.lista_precio_id"
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                    id="lista_precio_id" style="pointer-events: none;" {{ $newCliente['ruta_id'] ? 'disabled' : '' }}>
                    {{-- Deshabilitar si hay una ruta seleccionada --}}
