...
<body class="bg-gray-100 dark:bg-gray-900">
    <div class="min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        ...
        <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-4xl">
            <div class="bg-white dark:bg-gray-800 py-8 px-4 shadow sm:rounded-lg sm:px-10">
                        ...
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            <thead class="bg-gray-50 dark:bg-gray-700">
                                <tr>
                                    ...
                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Asignar Rol</th>
                                </tr>
                            </thead>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-300">
                                            <form action="{{ route('users.assign-role', $user) }}" method="POST">
                                                ...
                                                <div class="flex items-center">
                                                    <select name="role" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white dark:bg-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm dark:text-white dark:border-gray-600">
                ...
                @else
                    <p class="text-center text-gray-500 dark:text-gray-400">No se encontraron usuarios o roles.</p>
                @endif
            </div>
        </div>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', (event) => {
            ...
            // Confirmar antes de asignar un rol
