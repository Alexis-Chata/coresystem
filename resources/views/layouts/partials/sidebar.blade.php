<aside :class="sidebarToggle ? 'translate-x-0' : '-translate-x-full'"
            ...
            <li>
                <a class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                    href="#"
                    @click.prevent="selected = (selected === 'Productos' ? '':'Productos')"
                    ...
                    Productos
                    <svg class="absolute right-4 top-1/2 -translate-y-1/2 fill-current" :class="{ 'rotate-180': (selected === 'Productos') }" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            @can('view empleado')
                <li>
                    <a href="{{ route('empleado.index') }}" class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 @if(request()->routeIs('empleado.index')) bg-graydark dark:bg-meta-4 @endif">
            ...
            @can('view ruta')
            <li>
                <a href="{{ route('ruta.index') }}" class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 @if(request()->routeIs('ruta.index')) bg-graydark dark:bg-meta-4 @endif">
            ...
            @can('view padron')
            <li>
                <a href="{{ route('padron.index') }}" class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 @if(request()->routeIs('padron.index')) bg-graydark dark:bg-meta-4 @endif">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M14 16H9m10 0h3v-3.15a1 1 0 00-.84-.99L16 11l-2.7-3.6a1 1 0 00-.8-.4H5.24a2 2 0 00-1.8 1.1l-.8 1.63A6 6 0 002 12.42V16h2"></path>
                    <circle cx="6.5" cy="16.5" r="2.5"></circle>
                    <circle cx="16.5" cy="16.5" r="2.5"></circle>
                        ...
                        <ul class="mb-6 flex flex-col gap-1.5">
                            ...
                            <li>
                                <a class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                                    ...
                                    :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'Chart') && (
                                        page === 'Chart') }">
                            ...
                            <li>
                                <a class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                                    ...
                                    :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'UiElements') || (
                            ...
                            <li>
                                <a class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                                    ...
                                    :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'AuthPages') || (
