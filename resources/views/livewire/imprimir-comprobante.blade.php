        ...
        <tbody class="bg-white divide-y divide-gray-200">
            ...
            <form wire:submit.prevent="imprimir({{ $id }})">
                <tr>
                    ...
                    <td class="px-4 py-2 whitespace-nowrap">
                        <select wire:model.defer="series.{{ $id }}.impresora" class="border-gray-300 rounded-md shadow-sm focus:ring-gray-500 focus:border-gray-500 border p-2 bg-white focus:outline-none focus:ring-2" required>
