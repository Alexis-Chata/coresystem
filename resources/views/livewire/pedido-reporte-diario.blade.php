<div class="cont_reporte">
    ...
    <header class="flex justify-between items-center">
        ...
        <input type="date" wire:loading.attr="disabled" wire:model.live="fecha"
    ...
    <section class="mb-5.5" wire:loading.class="hidden" wire:target="fecha">
        @forelse($pedidosPorVendedor as $vendedorId => $pedidosVendedor)
            <details class="overflow-hidden my-1 mb-2 rounded-lg border dark:border-gray-700 group">
                <summary
                    class="flex justify-between items-center p-4 bg-blue-50 transition-colors cursor-pointer dark:bg-blue-800 group-open:bg-blue-100 dark:group-open:bg-blue-700">
                    <div class="flex gap-2 items-center">
                        ...
                        <span class="text-lg font-semibold text-gray-800 dark:text-white">
                            #{{ $pedidosVendedor->first()->vendedor->id }} -
                            {{ $pedidosVendedor->first()->vendedor->name }}
                        </span>
                    </div>
                    <span
                        class="px-3 py-1 text-sm font-medium text-blue-600 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-400">
                ...
                <div class="p-1 space-y-2 bg-blue-50 dark:bg-blue-800">
                    @foreach ($pedidosVendedor->groupBy('ruta_id') as $rutaId => $pedidosRuta)
                        <details class="overflow-hidden rounded-lg border dark:border-gray-700 group">
                            <summary
                                class="flex items-center p-3 bg-green-100 transition-colors cursor-pointer dark:bg-green-800 group-open:bg-green-200 dark:group-open:bg-green-700">
                                ...
                                <span
                                    class="px-3 py-1 ml-auto text-sm font-medium text-green-600 bg-green-100 rounded-full dark:bg-green-900 dark:text-green-400"
                            ...
                            <div class="p-1 bg-green-100 dark:bg-green-800">
                                @foreach ($pedidosRuta as $pedido)
                                    <details class="overflow-hidden mb-1 rounded-lg border dark:border-gray-700 group">
                                        <summary
                                            class="flex items-center p-3 bg-purple-100 transition-colors cursor-pointer dark:bg-purple-800 group-open:bg-purple-200 dark:group-open:bg-purple-700">
                                            <span
                                                class="flex-none p-1.5 mr-3 bg-purple-100 rounded-full dark:bg-purple-900">
                                            ...
                                            <div>
                                                <span class="font-medium text-gray-800 dark:text-gray-300">
                                                    ...
                                                    {{ match ((int) $pedido->f_tipo_comprobante_id) {
                                                        1 => '(NP)',
                                                        2 => '(F)',
                                                        3 => '(B)',
                                                        default => '(NP)',
                                            ...
                                            <span
                                                class="px-3 py-1 ml-auto text-sm font-medium text-purple-600 bg-purple-100 rounded-full dark:bg-purple-900 dark:text-purple-400"
                                                style="margin-left:auto">
                                        ...
                                        <div class="bg-purple-50 dark:bg-purple-800">
                                            <div class="overflow-x-auto">
                                                <table
                                                    ...
                                                    <tbody
                                                        class="bg-white divide-y divide-gray-200 dark:bg-gray-900 dark:divide-gray-700 dark:text-gray-400">
                                                    ...
                                                    <tfoot class="bg-gray-100 dark:bg-gray-700">
                                                        <tr>
                                                            ...
                                                            <td
                                                                class="px-6 py-4 font-medium text-right text-gray-800 dark:text-white">
                                                                Total Pedido:
                                                            </td>
    ...
    <div x-data="{ open: false }" x-show="open" @open-modal.window="open = true" @close-modal.window="open = false"
        ...
        <div class="flex justify-center items-center min-h-screen">
            ...
            <div class="relative w-full max-w-6xl bg-white rounded-lg shadow-xl modal_pad dark:bg-gray-800 sm:px-6">
                    ...
                    @if ($pedidoEnEdicion)
                        ...
                        <div class="grid gap-6 mb-4 md:grid-cols-2">
                            ...
                            <div class="relative">
                                <input type="text"
                                    class="block px-2.5 pt-4 pb-2.5 w-full text-sm text-gray-900 bg-transparent rounded-lg border border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                    value="{{ $pedidoEnEdicion->fecha_emision }}" disabled />
                                <label
                                    class="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-4 scale-8 top-2 z-10 origin-[0] bg-[#f1f5f9] dark:bg-[#1A222C] px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-8 peer-focus:-translate-y-4 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto start-1">
                                    Fecha
                                </label>
                        ...
                        <div class="relative mb-4" wire:loading.class="hidden"
                            wire:target="guardarCambios, eliminarPedido, actualizarCantidadDetalle, eliminarDetalle, agregarProducto">
                        ...
                        <!-- Tabla de productos -->
                        <table class="mt-4 w-full" wire:loading.class="hidden"
                            wire:target="guardarCambios, eliminarPedido, actualizarCantidadDetalle, eliminarDetalle, agregarProducto">
                            <thead
                                ...
                                <tr>
                                    ...
                                    <th scope="col">Importe <svg width="25" height="25"
                            ...
                            <tbody>
                                @foreach ($pedidoEnEdicion->pedidoDetalles as $detalle)
                                    <tr>
                                        ...
                                        <td>S/.
                                            {{ number_format($detallesEdit[$detalle->id]['importe'] ?? $detalle->importe, 2) }}
                            ...
                            <tfoot>
                                <tr class="font-semibold text-gray-900 dark:text-white">
                                    <td class="px-6 py-6" colspan="2" rowspan="3">
                                        ...
                                        <div class="hidden relative">
                                            <textarea rows="4" id="comentarios_edit" wire:model="comentarios"
                                    ...
                                    <td class="px-6 py-3 text-right">Subtotal: S/.
                                        {{ number_format($totales['valorVenta'], 2) }}</td>
                                </tr>
                                <tr class="font-semibold text-gray-900 dark:text-white">
                                ...
                                <tr class="font-semibold text-gray-900 dark:text-white">
                                    <td class="px-6 py-3 text-right">Total: S/.
                                        {{ number_format($totales['subTotal'], 2) }}</td>
                                </tr>
                            </tfoot>
                        </table>
                    @endif
                ...
                <!-- Modal Footer -->
                <div class="flex gap-3 justify-end py-4 border-t dark:border-gray-700" wire:loading.class="hidden"
                    wire:target="guardarCambios, eliminarPedido, actualizarCantidadDetalle, eliminarDetalle, agregarProducto">
                    @if ($pedidoEnEdicion)
