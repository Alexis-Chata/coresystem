...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $this->call([
            //CsvSeeder::class,
            RoleSeeder::class, // start
            EmpresaSeeder::class, // start
            FTipoDocumentoSeeder::class, // start
            VehiculoSeeder::class, // start
            FSedeSeeder::class, // start
            EmpleadoSeeder::class, // start
            FTipoComprobanteSeeder::class, // start
            //ListaPrecioSeeder::class,
            //RutaSeeder::class,
            //ClienteSeeder::class,
            //MarcaSeeder::class,
            //CategoriaSeeder::class,
            FTipoAfectacionSeeder::class, // start
            //ProductoSeeder::class,
            //ProductoListaPrecioSeeder::class,
            //PedidoSeeder::class,
            //ProveedorSeeder::class,
            //PadronSeeder::class,
            SerieSeeder::class, // start
            //AlmacenSeeder::class,
            TipoMovimientoSeeder::class, // start
